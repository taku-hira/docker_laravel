                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <form method="post" action="{{ route('admin.owners.update', ['owner' => $owner->id]) }}">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                    <label for="email" repuired class="leading-7 text-sm text-gray-600">メールアドレス</label>
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                    <label for="shop" repuired class="leading-7 text-sm text-gray-600">店名</label>
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                    <label for="password" repuired class="leading-7 text-sm text-gray-600">パスワード</label>
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                    <label for="password_confirmation" repuired class="leading-7 text-sm text-gray-600">パスワード（確認用）</label>
